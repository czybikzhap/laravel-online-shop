...
<div class="container ">
    <div class="card asics">
        <p class="price"><?php echo 'MY PROFILE' ?></p>

        <i class="info fas fa-info-circle"></i>

        <div class="imgBx">
            <img src="https://cs14.pikabu.ru/post_img/big/2021/05/12/3/1620786394143521977.jpg">
        </div>
        <div class="contentBx  ">
...
<style>
    * {
    ...
    body {
        background: url("https://cs14.pikabu.ru/post_img/big/2021/05/12/3/1620786394143521977.jpg") no-repeat center center fixed;
        display: flex;
        flex-direction: row;
    ...
    .container .card {
        ...
        height: 450px;
        border-radius: 20px;
        background: url("https://cs14.pikabu.ru/post_img/big/2021/05/12/3/1620786394143521977.jpg");
